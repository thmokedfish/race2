...
Shader "Procedural Worlds/Simple Water"
{
	...
	SubShader
	{
		...
		{
			float temp_output_130_0_g37 = _NormalScale;
			float2 temp_output_137_0_g37 = _WaveSpeed;
			float temp_output_6_0_g37 = (temp_output_137_0_g37).x;
			float2 temp_cast_0 = (temp_output_6_0_g37).xx;
			float temp_output_132_0_g37 = _GlobalTiling;
			float _Tiling389_g37 = temp_output_132_0_g37;
			float2 temp_cast_1 = (_Tiling389_g37).xx;
			float2 temp_cast_2 = (0.15).xx;
			float2 uv_TexCoord11_g37 = i.uv_texcoord * temp_cast_1 + temp_cast_2;
			float2 panner17_g37 = ( 1.0 * _Time.y * temp_cast_0 + uv_TexCoord11_g37);
			float cos272_g37 = cos( temp_output_6_0_g37 );
			float sin272_g37 = sin( temp_output_6_0_g37 );
			float2 rotator272_g37 = mul( panner17_g37 - float2( 0.2,0 ) , float2x2( cos272_g37 , -sin272_g37 , sin272_g37 , cos272_g37 )) + float2( 0.2,0 );
			float2 temp_cast_3 = (( temp_output_132_0_g37 + 2.0 )).xx;
			float2 temp_cast_4 = (1.2).xx;
			float2 uv_TexCoord10_g37 = i.uv_texcoord * temp_cast_3 + temp_cast_4;
			float2 panner16_g37 = ( 1.0 * _Time.y * (( temp_output_137_0_g37 / 2.0 )).xy + uv_TexCoord10_g37);
			float3 _Normal25_g37 = BlendNormals( UnpackScaleNormal( tex2D( _WaterNormal, rotator272_g37 ), temp_output_130_0_g37 ) , UnpackScaleNormal( tex2D( _WaterNormal, panner16_g37 ), ( temp_output_130_0_g37 - 0.001 ) ) );
			o.Normal = _Normal25_g37;
			float4 ase_screenPos = float4( i.screenPos.xyz , i.screenPos.w + 0.00000000001 );
			float4 ase_grabScreenPos = ASE_ComputeGrabScreenPos( ase_screenPos );
			float4 ase_grabScreenPosNorm = ase_grabScreenPos / ase_grabScreenPos.w;
			float4 screenColor86_g37 = tex2D( _GrabTexture, ( float3( (ase_grabScreenPosNorm).xy ,  0.0 ) + ( _Normal25_g37 * _Distortion ) ).xy );
			float4 _DistortionDeep383_g37 = ( screenColor86_g37 * ( 1.0 - 1.5 ) );
			float4 ase_screenPosNorm = ase_screenPos / ase_screenPos.w;
			ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
			float clampDepth20_g37 = Linear01Depth(UNITY_SAMPLE_DEPTH(tex2Dproj(_CameraDepthTexture,UNITY_PROJ_COORD( ase_screenPosNorm ))));
			float _ScreenPosition391_g37 = abs( ( clampDepth20_g37 - ase_screenPosNorm.w ) );
			float screenDepth555_g37 = LinearEyeDepth(UNITY_SAMPLE_DEPTH(tex2Dproj(_CameraDepthTexture,UNITY_PROJ_COORD( ase_screenPos ))));
			float distanceDepth555_g37 = abs( ( screenDepth555_g37 - LinearEyeDepth( ase_screenPosNorm.z ) ) / ( saturate( pow( ( _ScreenPosition391_g37 + ( 1.0 - 1.0 ) ) , ( 1.0 - 1.0 ) ) ) ) );
			float _WaterDepth559_g37 = distanceDepth555_g37;
			float clampResult606_g37 = clamp( _WaterDepth559_g37 , 0.0 , 2.0 );
			float clampResult666 = clamp( 0.0 , 0.0 , 30.0 );
			float clampResult668 = clamp( 1.0 , 0.0 , 5.0 );
			float4 lerpResult583_g37 = lerp( ( float4(0.05201113,0.1105556,0.1911763,1) * ( 1.0 - 1.0 ) ) , _DistortionDeep383_g37 , ( 1.0 - saturate( pow( ( clampResult606_g37 + ( 1.0 - clampResult666 ) ) , ( 1.0 - clampResult668 ) ) ) ));
			float4 _DeepColor598_g37 = saturate( lerpResult583_g37 );
			float clampResult681 = clamp( _SurfaceOpacity , 0.5 , 1.0 );
			float temp_output_331_0_g37 = ( 1.0 - clampResult681 );
			float4 lerpResult657_g37 = lerp( _DeepColor598_g37 , _DistortionDeep383_g37 , temp_output_331_0_g37);
			float temp_output_625_0_g37 = _SurfaceColorBlend;
			float4 _DistortionShallow382_g37 = screenColor86_g37;
			float clampResult642_g37 = clamp( _WaterDepth559_g37 , 0.0 , 8.0 );
			float clampResult597 = clamp( 0.0 , 0.0 , 30.0 );
			float clampResult596 = clamp( 1.0 , 0.0 , 5.0 );
			float4 lerpResult617_g37 = lerp( ( _SurfaceColor * temp_output_625_0_g37 ) , _DistortionShallow382_g37 , ( 1.0 - saturate( pow( ( clampResult642_g37 + ( 1.0 - clampResult597 ) ) , ( 1.0 - clampResult596 ) ) ) ));
			float4 _ShallowColor634_g37 = saturate( lerpResult617_g37 );
			float4 lerpResult658_g37 = lerp( _ShallowColor634_g37 , _DistortionShallow382_g37 , temp_output_331_0_g37);
			float clampResult668_g37 = clamp( _WaterDepth559_g37 , 0.0 , 1.0 );
			float4 lerpResult654_g37 = lerp( lerpResult657_g37 , lerpResult658_g37 , abs( pow( clampResult668_g37 , ( 1.0 - 1.0 ) ) ));
			float4 clampResult692_g37 = clamp( lerpResult654_g37 , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
			float clampResult610 = clamp( 3.5 , 2.0 , 4.0 );
			float clampResult562_g37 = clamp( saturate( pow( ( _WaterDepth559_g37 + ( 1.0 - 0.4941176 ) ) , ( 1.0 - clampResult610 ) ) ) , 0.0 , 3.0 );
			float2 temp_cast_7 = (( _Tiling389_g37 * 2.1 )).xx;
			float2 uv_TexCoord45_g37 = i.uv_texcoord * temp_cast_7;
			float2 panner49_g37 = ( 1.0 * _Time.y * float2( -0.01,0.01 ) + uv_TexCoord45_g37);
			float4 clampResult663_g37 = clamp( ( clampResult562_g37 * _FoamTint * tex2D( _FoamMap, panner49_g37 ) ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
			float4 lerpResult328_g37 = lerp( clampResult663_g37 , float4( 0,0,0,0 ) , ( 1.0 - _FoamOpacity ));
			float4 _FoamAlbedo314_g37 = saturate( lerpResult328_g37 );
			float4 _Albedo105_g37 = saturate( ( clampResult692_g37 + _FoamAlbedo314_g37 ) );
			o.Albedo = _Albedo105_g37.rgb;
			...
			#endif //aseld
			float dotResult35_g37 = dot( (WorldNormalVector( i , _Normal25_g37 )) , ase_worldlightDir );
			float temp_output_116_0_g37 = 1.0;
			float _FakeShadow99_g37 = ( 1.0 - saturate( (dotResult35_g37*temp_output_116_0_g37 + temp_output_116_0_g37) ) );
			float4 lerpResult143_g37 = lerp( texCUBE( SkyboxReflection, WorldReflectionVector( i , _Normal25_g37 ) ) , float4( 1,1,1,0 ) , _FakeShadow99_g37);
			float4 _Reflections95_g37 = saturate( lerpResult143_g37 );
			float clampResult310 = clamp( ( 1.0 - 1.0 ) , 0.0 , 1.0 );
			o.Emission = ( _Reflections95_g37 * clampResult310 ).rgb;
			float clampResult231_g37 = clamp( _WaterSpecular , 0.0 , 0.1 );
			float clampResult232_g37 = clamp( 1.0 , 0.0 , 0.2 );
			float lerpResult97_g37 = lerp( clampResult231_g37 , clampResult232_g37 , _FoamAlbedo314_g37.r);
			float _Specular104_g37 = lerpResult97_g37;
			float3 temp_cast_11 = (_Specular104_g37).xxx;
			o.Specular = temp_cast_11;
			float clampResult402_g37 = clamp( _WaterSmoothness , 0.0 , 0.97 );
			float lerpResult96_g37 = lerp( clampResult402_g37 , 1.0 , _FoamAlbedo314_g37.r);
			float _Smoothness98_g37 = lerpResult96_g37;
			o.Smoothness = _Smoothness98_g37;
			float _AmbientOcclusion672_g37 = 1.0;
			o.Occlusion = _AmbientOcclusion672_g37;
			float clampResult556_g37 = clamp( distanceDepth555_g37 , 0.0 , 1.0 );
			float _EdgeBlend490_g37 = clampResult556_g37;
			o.Alpha = _EdgeBlend490_g37;
		}
...
/*ASEBEGIN
Version=15600
277;56;1045;723;1777.087;625.0744;1.227507;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;435;-1505.986,-220.1141;Float;False;Property;_SurfaceOpacity;Surface Opacity;4;0;Create;True;0;0;False;0;1;0.661;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;245;-1478.323,-119.3994;Float;False;Property;_WaveSpeed;Wave Speed;3;0;Create;True;0;0;False;0;-0.04,0.045;-0.045,0.0225;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;351;-1520.862,1134.512;Float;False;Property;_FoamTint;Foam Tint;13;0;Create;True;0;0;False;0;1,1,1,0;0.5294118,0.5294118,0.5294118,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;79;-1517.524,-949.1722;Float;False;Property;_GlobalTiling;Global Tiling;2;0;Create;True;0;0;False;0;50;2048;0;32768;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;426;-1522.069,1314.222;Float;False;Property;_FoamOpacity;Foam Opacity;14;0;Create;True;0;0;False;0;1;0.4;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;34;-1496.335,-671.2239;Float;False;Property;_NormalScale;Normal Scale;6;0;Create;True;0;0;False;0;0.4;0.15;0.025;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;469;-1516.762,-1059.099;Float;False;Property;_SurfaceColorBlend;Surface Color Blend;8;0;Create;True;0;0;False;0;0.9;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;51;-1488.671,-586.8487;Float;False;Property;_SurfaceColor;Surface Color;7;0;Create;True;0;0;False;0;0.4329584,0.5616246,0.6691177,1;0,0.5416665,1,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;725;595;476;0
WireConnection;725;625;469;0
WireConnection;725;132;79;0
WireConnection;725;131;262;0
WireConnection;725;130;34;0
WireConnection;725;628;51;0
WireConnection;725;611;47;0
WireConnection;725;330;681;0
WireConnection;725;137;245;0
WireConnection;725;630;597;0
WireConnection;725;594;666;0
WireConnection;725;558;539;0
WireConnection;725;626;596;0
WireConnection;725;590;668;0
WireConnection;725;122;69;0
WireConnection;725;123;70;0
WireConnection;725;655;670;0
WireConnection;725;119;53;0
WireConnection;725;138;261;0
WireConnection;725;234;351;0
WireConnection;725;320;426;0
WireConnection;725;124;38;0
WireConnection;725;125;610;0
WireConnection;725;120;73;0
WireConnection;725;121;75;0
WireConnection;725;117;185;0
WireConnection;725;116;230;0
WireConnection;310;0;629;0
WireConnection;302;0;725;107
WireConnection;302;1;310;0
WireConnection;0;0;725;0
WireConnection;0;1;725;106
WireConnection;0;2;302;0
WireConnection;0;3;725;108
WireConnection;0;4;725;109
WireConnection;0;5;725;674
WireConnection;0;9;725;146
ASEEND*/
//CHKSM=A3A1E4E3ABB0F5C53AFDC0A62F39C01788546751