...
namespace Gaia
{
    ...
    public class GaiaReflectionProbeUpdate : MonoBehaviour
    {
        ...
        public bool m_boxProjection = true;
        ...
        void SetProbeSettings()
        {
            ...
            {
                reflectionProbe.size = new Vector3(125f, 500f, 125f);
            }
        ...
        public void ProbeFollow()
        {
            if (m_mainCameraObject != null)
            {
                m_reflectionProbe.gameObject.transform.localPosition = m_mainCameraObject.transform.position;
            }
        }
        #endregion
